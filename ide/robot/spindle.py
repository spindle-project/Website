...
robo_commands = []
robo_mode = True; # Boolean for robo mode. IE should Spindle return what the robot does or ignore commands. 
# IMPORTS 
...
#SPECIFIC TO ROBOT IDE
global_symbol_table.set("MOVE_FORWARD", BuiltInFunction.move_forward)
global_symbol_table.set("OTATE_LEFT", BuiltInFunction.rotate_left)
global_symbol_table.set("OTATE_RIGHT", BuiltInFunction.rotate_right)
